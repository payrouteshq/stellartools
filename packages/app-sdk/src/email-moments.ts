...
export const EMAIL_MOMENTS: EmailMoment[] = [
  { event: "customer.created", label: "Customer created email", description: "Sent when someone creates an account", featured: true },
  ...
  { event: "payment_method.created", label: "Payment method added email", description: "Sent when a customer saves a payment method" },
  { event: "payment_method.deleted", label: "Payment method removed email", description: "Sent when a saved payment method is deleted" },
  ...
  { event: "payment.confirmed", label: "Successful payment email", description: "Sent when a payment goes through", featured: true },
  ...
  { event: "subscription.created", label: "Subscription created email", description: "Sent when someone starts a subscription", featured: true },
  { event: "subscription.updated", label: "Subscription update email", description: "Sent when a plan or status changes" },
  { event: "subscription.canceled", label: "Subscription canceled email", description: "Sent when a subscription ends" },
];
