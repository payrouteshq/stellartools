...
<ResponseField name="unit_divisor" type="number">
  How many units make one billable credit.
</ResponseField>
...
<ResponseField name="credits_granted" type="number">
  Credits granted to the customer when this product is purchased.
</ResponseField>
...
<ParamField body="unit_divisor" type="number">
  Units per billable credit.
</ParamField>
...
<ParamField body="credits_granted" type="number">
