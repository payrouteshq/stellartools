...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  paymentSrcNoTrust: "The customer's wallet has no trustline for this asset.",
  paymentNoIssuer: "Asset issuer not found on the network.",
  paymentNotAuthorized: "The customer's wallet is not authorized to hold this asset.",
