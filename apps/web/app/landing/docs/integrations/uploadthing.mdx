...
The `@stellartools/uploadthing-adapter` package adds a `shield` function that wraps [UploadThing](https://uploadthing.com) with StellarTools subscription gating. It returns a route factory you use in place of `createUploadthing()`.
